...
__WEBPACK_IMPORTED_MODULE_0_jquery__["ajax"]("data.json",{
...
__WEBPACK_IMPORTED_MODULE_0_jquery__["getJSON"]("data.json", {"lang":["en","fr"]},
    function(result){
        res.innerText +=" "+ result.nom+" "+result.prenom[0];
...
__WEBPACK_IMPORTED_MODULE_0_jquery__["get"]("data.json", {"lang":["en","fr"]},
    function(result){
