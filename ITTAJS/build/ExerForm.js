...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_ui__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery_validation__ = __webpack_require__(5);
...
if (false) {//validation manuel
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__(function(){
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#envoi").click(function(){
            if ($form.valid()) {
                alert($form.serialize());
            } 
        });   
    
        var $form =__WEBPACK_IMPORTED_MODULE_0_jquery__('form[name="formulaire"]');
        ...
        $form.validate({
            ...
            messages:{
                nom:{
                    ...
                    maxlength: __WEBPACK_IMPORTED_MODULE_0_jquery__["validator"].format("taille max {0}")
                },
                age:{
                    min: __WEBPACK_IMPORTED_MODULE_0_jquery__["validator"].format("Age min {0}"),
                    max: __WEBPACK_IMPORTED_MODULE_0_jquery__["validator"].format("Age max {0}")
                }
            },
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__["validator"].addMethod("customVal",function (value, element) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=ExerForm.js.map